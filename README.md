...
[![Version](https://img.shields.io/badge/version-v1.2.7-blue.svg)](VERSION_HISTORY.md)
...
> **👁️ v1.2.7 wait()API・敵AI視覚システム完成！** wait()導入・方向性視覚・ステージ毎設定・Stage07-10追加・高度な戦略的学習実現 - 詳細は [VERSION_HISTORY.md](VERSION_HISTORY.md) をご覧ください
...
- **10段階学習ステージ**: 基礎移動→戦闘→プログラミング構造→高度戦術（Stage01-10対応）
